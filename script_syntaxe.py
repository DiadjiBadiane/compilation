...
def execute_ko(chemin_fichier):
	global nb_error_ko
	process = subprocess.Popen(["./minicc", chemin_fichier, "-s"], stdout=subprocess.PIPE, stderr=subprocess.PIPE)

	output, error = process.communicate()

	output_str = output.decode()

	#print("DEBUG DEBUG",  output_str, "DEBUG DEBUG")
...
repertoire = (os.path.join(repertoire, "Tests/Syntaxe/KO")) # le chemin des fichiers de tests
...
#OK
repertoire = os.getcwd()
repertoire = (os.path.join(repertoire, "Tests/Syntaxe/OK"))
