...
def execute_ko(chemin_fichier):
	global nb_error_ko
	process = subprocess.Popen(["./minicc", chemin_fichier, "-v"], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
...
repertoire = (os.path.join(repertoire, "Tests/Verif/KO")) # le chemin des fichiers de tests
...
#OK
repertoire = os.getcwd()
repertoire = (os.path.join(repertoire, "Tests/Verif/OK"))
